...
public class Config
{
    private static final File CONFIG_FILE = new File(FabricLoader.getInstance().getConfigDir().toFile(), "feamc.properties");
    private static final String CONFIG_COMMENT = "feamc config file";
    private static final String SIMPLIFIED_CHEST = "simplified";
