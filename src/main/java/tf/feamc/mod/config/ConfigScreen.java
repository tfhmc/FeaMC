...
{
    private static final Text SCREEN_TITLE = Text.literal(" feamc config");
    private static final Text SIMPLIFIED_ON = Text.literal("Simplified: ON");
    private static final Text SIMPLIFIED_OFF = Text.literal("Simplified: OFF");
